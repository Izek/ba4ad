...
public class BooksProvider extends ContentProvider {
	...
	static final String PROVIDER_NAME = "com.shumz.provider.Books";
	...
	public String getType(Uri uri) {
		...
		case BOOKS:
			...
			return "vnd.android.cursor.dir/vnd.shumz.books ";
			// ---get a particular book---
		case BOOK_ID:
			return "vnd.android.cursor.item/vnd.shumz.books ";
		default:
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		if (sortOrder == null || sortOrder == "")
			sortOrder = TITLE;
		Cursor c = sqlBuilder.query(booksDB, projection,
